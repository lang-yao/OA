    ...
    var Marking = function (ele, opt) {
        this.$element = ele,
            this.defaults = {
                ...
                'width': 20,
                'spaceBetween': 2,
                'backgroundImageInitial': '../../static/images/star_hollow.png', //图标初始样式
                // 'backgroundImageInitial': window.location.host + '/static/images/star_hollow.png', //图标初始样式
                // 'backgroundImageOver': window.location.host + '/static/images/star_solid.png', //点击后图标
                'backgroundImageOver': '../../static/images/star_solid.png', //点击后图标
                // 'backgroundImageOver': '../../static/images/star_solid.png', //点击后图标
                'num': 5, //图标数量
